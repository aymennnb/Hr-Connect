...
export default function IndexPublic({ auth, conges, users, flash }) {
    ...
    const myConges = conges.filter(conge => conge.user_id === auth.user.id);
    ...
    useEffect(() => {
        ...
        setCurrentPage(1);
    }, [data.searchTerm,data.motif,data.status,data.start_date,data.end_date]);
    //     }, [data, myConges]);
